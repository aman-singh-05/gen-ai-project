...
const Interview = () => {
    ...
    // useInterview's own useEffect already fetches the report when interviewId is present.
    // No secondary useEffect needed here.
    ...
    const scoreLabel =
        report.matchScore >= 80 ? 'Strong match for this role' :
            report.matchScore >= 60 ? 'Decent match — some gaps' : 'Needs preparation'
